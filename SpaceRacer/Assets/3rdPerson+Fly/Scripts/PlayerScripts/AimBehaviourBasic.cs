...
public class AimBehaviourBasic : GenericBehaviour
{
	...
	void Update ()
	{
		...
		if (InputSystem.actions.FindAction("Attack").ReadValue<float>() != 0 && !aim)
		{
			StartCoroutine(ToggleAimOn());
		}
		else if (aim && InputSystem.actions.FindAction("Attack").ReadValue<float>() == 0)
		{
		...
		if (aim && InputSystem.actions.FindAction("Shoulder").WasPerformedThisFrame())
		{
